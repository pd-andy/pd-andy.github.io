...
var author$project$Content$Sections$education = {
	...
	content: _List_fromArray(
		[
			...
			{degree: 'PhD Media and Arts Technology', university: 'Queen Mary University of London', when: '2017 – 2021'}),
			author$project$Content$Sections$University(
			{degree: 'MA Computational Art', university: 'Goldsmiths University of London', when: '2016 – 2017'}),
			author$project$Content$Sections$University(
			{degree: 'Ba(Hons) Creative Music Technology', university: 'Bath Spa University', when: '2013 – 2016'})
		]),
	heading: 'Education',
	id: 'education'
};
...
var author$project$Content$Sections$Subheading = function (a) {
...
var author$project$Content$Socials$SocialMedia = F3(
	function (name, icon, link) {
		return {icon: icon, link: link, name: name};
	});
var author$project$Content$Socials$all = _List_fromArray(
	[
...
var author$project$Main$FocusedElement = function (a) {
	return {$: 'FocusedElement', a: a};
};
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Main$onFocusChange = _Platform_incomingPort('onFocusChange', elm$json$Json$Decode$string);
var elm$core$Platform$Sub$batch = _Platform_batch;
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$Main$onFocusChange(author$project$Main$FocusedElement)
			]));
};
...
var author$project$Content$Nav$item = F3(
	function (focusedSection, msg, _n0) {
		var id = _n0.id;
		var colour = _n0.colour;
		return A2(
	...
	switch (content.$) {
		case 'Paragraph':
			...
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('mt-4 text-lg text-justify')
					]),
				_List_fromArray(
					[
		...
		case 'Subheading':
			...
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('mt-4 text-2xl font-bold border-b-2 border-gray-900 mb-4')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(string)
		...
		case 'Job':
			...
			var employer = content.a.employer;
			var when = content.a.when;
			return A2(
				elm$html$Html$div,
				_List_fromArray(
		...
		case 'Project':
			var title = content.a.title;
			var technology = content.a.technology;
			var description = content.a.description;
			var github = content.a.github;
			return A2(
				elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('text-md italic border-b-2 border-gray-900 inline-block pb-1')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$href(github)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('fab fa-github-square mr-2')
									]),
								_List_Nil),
								A2(
								elm$html$Html$span,
								...
								_List_fromArray(
									[
										elm$html$Html$text('Find it on GitHub.')
									]))
							]))
					]));
		default:
			var name = content.a.name;
			var level = content.a.level;
			return A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('mt-4 text-lg flex justify-between')
					]),
				_List_fromArray(
					[
						A2(
...
var author$project$Content$Socials$button = function (social) {
	return A2(
		elm$html$Html$a,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('flex flex-col items-center my-6'),
				elm$html$Html$Attributes$href(social.link)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$class('fa-2x')
					]),
				_List_Nil),
				A2(
				elm$html$Html$span,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('text-sm my-2')
					]),
				_List_fromArray(
					[
	...
	return A2(
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text('Andrew Thompson')
									])),
								A2(
								elm$html$Html$h2,
								_List_fromArray(
						...
						A2(
							elm$core$List$map,
							A2(author$project$Content$Nav$item, model.focusedElement, author$project$Main$ScrollTo),
							model.sections))
					])),
				A2(
				elm$html$Html$main_,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('shadow-xl')
					]),
				A2(elm$core$List$map, author$project$Content$Sections$view, model.sections))
			]));
};
...
var _scrollTo = _interopRequireDefault(require("./js/scrollTo"));
